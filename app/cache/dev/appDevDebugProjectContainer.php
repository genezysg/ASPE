...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'ASPEBundle' => 'ASPEBundle\\ASPEBundle',
            ...
            'locale' => 'en',
            'secret' => '979c495d3d3a37ed3cde53d0c639e1fc2c84ed81',
            'database_path' => NULL,
            ...
            'kernel.secret' => '979c495d3d3a37ed3cde53d0c639e1fc2c84ed81',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'/src/AppBundle/Entity'))), 'AppBundle\\Entity');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fc7f78f48c15d638ef15c3e060aa41065076e2d30ea98d9ac5cca63af3e2fbb5');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/ASPEBundle/Resources/views'), 'ASPE');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('979c495d3d3a37ed3cde53d0c639e1fc2c84ed81');
    }
