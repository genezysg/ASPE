...
class TopicoController extends FOSRestController {
	...
	public function postTopicoAction(Request $request)
	{
		try {
			...
			return $this->routeRedirectView('api_1_get_topico', $routeOptions, Codes::HTTP_CREATED);
	...
	public function deleteTopicoAction($codigo, Request $request, ParamFetcherInterface $paramFetcher)
	{
		try {
			...
			return $this->routeRedirectView('api_1_get_topicos', $routeOptions, $statusCode);
		} catch (InvalidFormException $exception) {
	...
	public function putTopicoAction(Request $request, $codigo)
	{
		try {
			...
			return $this->routeRedirectView('api_1_get_topico', $routeOptions, $statusCode);
	...
	public function patchTopicoAction(Request $request, $codigo)
	{
		try {
			...
			return $this->routeRedirectView('api_1_get_topico', $routeOptions, Codes::HTTP_NO_CONTENT);
